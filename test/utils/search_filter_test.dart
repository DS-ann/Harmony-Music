...
void main() {
  group('SearchFilter matches tests', () {
    ...
    test('Scoped filters (a:, artist:) match', () {
      ...
      expect(
        SearchFilter.matches(fields, 'a:Linkin Park'),
        isFalse,
      ); // Linkin Park is title, not artist
    });
    ...
    test('Scoped filters (t:, title:) match', () {
      ...
      expect(
        SearchFilter.matches(fields, 't:Linkin Park'),
        isFalse,
      ); // Linkin Park is artist, not title
    });
    ...
    test('Complex combined filters', () {
      ...
      expect(
        SearchFilter.matches({'title': 'One', 'artist': 'Metallica'}, query),
        isFalse,
      );
    });
